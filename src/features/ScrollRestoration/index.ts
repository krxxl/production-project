...
} from './model/selectors/getScrollRestorationData/getScrollRestorationData';

export {
  getScrollRestorationDataByPath,
} from './model/selectors/getScrollRestorationDataByPath/getScrollRestorationDataByPath';
