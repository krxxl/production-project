...
import { fetchArticleDetailRecommendations } from '../../model/services/fetchArticleDetailRecommendations/fetchArticleDetailRecommendations';
...
const articleDetailRecommendationsSlice = createSlice({
  ...
  initialState:
    recommendationsAdapter.getInitialState<ArticleDetailRecommendationsSchema>({
      isLoading: false,
      error: undefined,
      ids: [],
      entities: {},
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(
        fetchArticleDetailRecommendations.fulfilled,
